...
xmlhttp_chat_panel_question.onreadystatechange=function()
  ...
  if (xmlhttp_chat_panel_question.readyState==4 && xmlhttp_chat_panel_question.status==200)
	...
	if (chat_panel_question_answer[1] != "0"){
		chat_panel_question_cancel();
	} else {
		document.getElementById("chat_animation").style.display = "none";
		document.getElementById("chat_panel_users").innerHTML = 
		"<div class=\"chat_panel_questions_background\">"+
		"<div class=\"chat_panel_questions\">Please <a onclick=\"login_signup()\"><font color=\"red\">log in</font></a> to chat</div>"+
		"</div>";
	} 
	} else {
	chat_online_friends();
...
xmlhttp_chat_panel_question.open("GET","chat/chat_panel_question_course.php", true);
...
xmlhttp_chat_panel_question_submit.open("GET","chat/chat_panel_question_submit_course.php?anonymous="+anonymous, true);
...
xmlhttp_chat_panel_question_cancel.open("GET","chat/chat_panel_question_submit_course.php?anonymous="+anonymous, true);
...
function chatwith(num,id,chatid,name) {
        ...
        "<textarea rows='1' type='text' id='chatbox_input_area_"+num+"' class='chatbox_input_area_offline' disabled='true' value='The user is offline' ></textarea>"+
		"</div>";
		} else {
        div.innerHTML = "<div class='chatbox_head'><div class='chatbox_name'>"+decode_utf8(name)+"</div>"+
        "<div id='chatbox_writing_"+num+"' class='chatbox_writing'></div>"+
		...
		"</div>"+
		"<div class='chatbox_input'>"+
        "<textarea rows='1' type='text' id='chatbox_input_area_"+num+"' class='chatbox_input_area' onkeyup='chat_input(this.value,"+num+","+id+",\""+chatid+"\",event)' ></textarea>"+
...
xmlhttp_chat_input.open("GET","chat/chat_input_course.php?msg="+msg+"&otherid="+id+"&otherchatid="+chatid, true);
...
xmlhttp_chat_output_open.open("GET","chat/chat_output_open_course.php?otherid="+id+"&otherchatid="+chatid, true);
...
xmlhttp_chat_output.open("GET","chat/chat_output_course.php?otherid="+id+"&otherchatid="+chatid, true);
...
xmlhttp_chat_online_friends_counter.open("GET","chat/chat_online_count_course.php", true);
...
function chatname_offline_num(num)
{
	...
	document.getElementById(chatbox_input_area_id).value = "The user is offline";	
	} 
...
xmlhttp_chat_online_friends.onreadystatechange=function()
  ...
  if (xmlhttp_chat_online_friends.readyState==4 && xmlhttp_chat_online_friends.status==200)
	...
	{
	document.getElementById("chat_panel_users").innerHTML = 
	"<div class='chat_online_user_nouser'>No one is online now</div>";
	} else {
...
xmlhttp_chat_online_friends.open("GET","chat/chat_online_friends_course.php", true);
...
xmlhttp_chat_unreceive_ids.open("GET","chat/chat_unreceive_who_course.php", true);
...
xmlhttp_chat_unreceive_names.open("GET","chat/chat_unreceive_name_course.php?otherid="+id+"&otherchatid="+chatid, true);
...
xmlhttp_chat_unreceive_messages.open("GET","chat/chat_unreceive_num_course.php?otherid="+id+"&otherchatid="+chatid, true);
...
xmlhttp_chat_animation_start.onreadystatechange=function()
  ...
  if (xmlhttp_chat_animation_start.readyState==4 && xmlhttp_chat_animation_start.status==200)
	...
	document.getElementById("chat_animation_user_name").innerHTML = "<font color=red>Me</font>" + "（"+chat_animation_start[2]+"）";
	}
  }
xmlhttp_chat_animation_start.open("GET","chat/chat_animation_start_course.php", true);
...
xmlhttp_chat_animation_others.open("GET","chat/chat_animation_others_course.php?others_pn="+others_pn, true);
...
xmlhttp_chat_animation_others_move.open("GET","chat/chat_animation_others_move_course.php?i="+i, true);
...
xmlhttp_chat_animation_move.open("GET","chat/chat_animation_move_course.php?xpos="+xpos+"&ypos="+ypos, true);
...
xmlhttp_chat_animation_click_move_right.open("GET","chat/chat_animation_move_course.php?xpos="+xpos+"&ypos="+ypos, true);
...
xmlhttp_chat_animation_click_move_left.open("GET","chat/chat_animation_move_course.php?xpos="+xpos+"&ypos="+ypos, true);
...
xmlhttp_chat_animation_click_move_down.open("GET","chat/chat_animation_move_course.php?xpos="+xpos+"&ypos="+ypos, true);
...
xmlhttp_chat_animation_click_move_up.open("GET","chat/chat_animation_move_course.php?xpos="+xpos+"&ypos="+ypos, true);
...
"<div class=\"chat_animation_posts\">Posts from "+decode_utf8(name)+"</div>"+
"</div></div>"+
...
xmlhttp_see_pmsg.open("GET","chat/chat_animation_see_msgs_course.php?otherid="+id,true);
