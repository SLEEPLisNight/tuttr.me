...
<title>tuttr.me - <?php echo $schoolname; ?></title>
...
<body onload=init(<?php echo json_encode($timezonename.'|home.php?schoolid='.$schoolid); ?>)>
...
<a><li class='menu' onmouseover=this.className='menu_onmouseover' onmouseout=this.className='menu' onclick=see_my_msgs() >My Posts</li></a> 
...
<div id="duitasuo_post"> 
  ...
  <?php echo "<a id='post_button' name='post_button' class='post_button' onclick='post_msg(".$schoolid.")' >Post</a>"; ?>
...
<?php 
echo "<a id='refresh_posts' class='refresh_posts' onclick=refresh_duitasuo('0','".$schoolid."')>Refresh</a>";
?>
</div>
</div>
...
<?php
if (isset($getrole)){
	$sql = mysql_query("SELECT * FROM duitasuomsg WHERE schoolid='$schoolid' AND role='$getrole' ORDER BY timesubmit DESC;") or die();
} else {
...
$timenow = time();
if (isset($getrole)){
	$duitasuo_msg = mysql_query("SELECT * FROM duitasuomsg WHERE schoolid='$schoolid' AND role='$getrole' ORDER BY timesubmit DESC") OR die(mysql_query());
} else {
 ...
 if ($imagelocation != ""){
	 ...
	 if ($msgowner == 1){
		 echo "<div class='post_owner'>
			   ...
			   </a> (<a id='role_msg_".$msgid."' href='home.php?schoolid=".$schoolid."&role=".$role."'>".$role."</a>): </h4>
...
while ($row_comment = mysql_fetch_assoc($duitasuo_comment)){ 
 ...
 $comment_imagelocation = $row_comment_user['imagelocation'];
...
if (isset($getgender)){
	...
	if ($lastPage != "1" && $pn != $lastPage && $nr != 0){
		echo "<a id='nextpage' class='nextpage' onclick=refresh_duitasuo(".$pn.",'".$schoolid."')>load more</a>";
    }
}
		...
		if ($h > 0){
			if ($usercourse_students[$k] == 0 && $usercourse_tutors[$k] == 0){
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div class='new_coursemsgs'>".$h."</div> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>No Roles</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				...
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div class='new_coursemsgs'>".$h."</div> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>Student</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				echo "<div id='update_roles_".$k."' class='update_roles_class' style='display:none'>You are: 
				...
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div class='new_coursemsgs'>".$h."</div> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>Tutor</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				echo "<div id='update_roles_".$k."' class='update_roles_class' style='display:none'>You are: 
				...
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div class='new_coursemsgs'>".$h."</div> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>Student &amp; Tutor</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				echo "<div id='update_roles_".$k."' class='update_roles_class' style='display:none'>You are: 
			...
			if ($usercourse_students[$k] == 0 && $usercourse_tutors[$k] == 0){
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>No Roles</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				echo "<div id='update_roles_".$k."' class='update_roles_class' style='display:none'>You are: 
					  <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],1,this)'>Student <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],2,this)'>Tutor 
					  </div>";
				...
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>Student</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				echo "<div id='update_roles_".$k."' class='update_roles_class' style='display:none'>You are: 
					  <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],1,this)' checked>Student <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],2,this)'>Tutor 
					  </div>";
				...
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>Tutor</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				echo "<div id='update_roles_".$k."' class='update_roles_class' style='display:none'>You are: 
					  <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],1,this)'>Student <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],2,this)' checked>Tutor 
					  </div>";
				...
				echo "<div class='user_classes'>
					  <b><font color='#6A6A6A'><a href='course.php?schoolid=".$schoolid."&courseid=".$courseids[$k]."'>".$coursenumbers[$k]."</a></font></b> <div id='roles_".$k."' onclick='show_update_roles($k)' class='course_user_roles'>Student &amp; Tutor</div> <a class='delete_class' onclick='deletecourse(".$courseids[$k].",".$schoolid.")'>x</a>
					  </div>";
				echo "<div id='update_roles_".$k."' class='update_roles_class' style='display:none'>You are: 
					  <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],1,this)' checked>Student <input type='checkbox' onchange='updateroles($k,$usercourses_ids[$k],2,this)' checked>Tutor 
					  </div>";
...
<div id="top_msgs">
<h2><?php echo $schoolname ?> Top 10 Posts </h2>
<div id="top_posts">
<?php 
...
<div class="buttons">
<?php echo "<p id='login_button' class='login_button' onclick=login(".$schoolid.")>Log in</p>"; ?>
...
<input type="text" id="course_search_input" onkeyup="course_search(<?php echo $schoolid; ?>)" oninput="course_search(<?php echo $schoolid; ?>)" onpropertychange="course_search(<?php echo $schoolid; ?>)" onfocus="if(this.value=='Add Your Class (Math 101)'){this.value=''};" onblur="if(this.value==''){this.value='Add Your Class (Math 101)';};" value="Add Your Class (Math 101)"/>
...
<div class='chatbox_name'><?php echo $schoolname ?></div>
