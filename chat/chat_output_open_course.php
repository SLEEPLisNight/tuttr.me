...
while($row = mysql_fetch_array($result)){
   	...
   	*/
   	$chatwith_result = mysql_query("SELECT * FROM coursechatname WHERE userid='$touserid' AND userchatid='$touserchatid' AND courseid='$courseid'");
...
for($i=0; $i<$h; $i++){
	if ($chat==""){
        ...
        <p class='chatbox_content_box_sender'><a href='profile.php?userid=".$touserid."'>".$sendername."</a></p><p class='chatbox_content_box_time'>".date("g:ia",strtotime($timezonename,strtotime($sendtime[$i])))."</p>
