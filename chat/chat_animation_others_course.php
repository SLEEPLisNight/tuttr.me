...
$dataFile = "coursepagevisitors.txt";
...
foreach($users as $key => $data) {
	...
	$onlinecourseid = $ipinfo[2];
	if($onlinechatid != $userchatid && $onlinecourseid == $courseid){
	$result = mysql_query("SELECT * FROM coursechatname WHERE userid = '$onlineid' AND userchatid='$onlinechatid' AND courseid='$courseid' ORDER BY id ASC;") or die();
