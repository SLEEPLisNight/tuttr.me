...
if ($number > 0) {
	...
	/*
   	$chatwith_result = mysql_query("SELECT * FROM chatnum WHERE userid='$userid' AND userip='$userip' AND touserid='$touserid[0]' AND touserip='$touserip[0]' AND courseid='$courseid'");
 	*/
	$chatwith_result = mysql_query("SELECT * FROM coursechatname WHERE userid='$fromuser_id' AND userchatid='$fromuser_chatid' AND courseid='$courseid'");
