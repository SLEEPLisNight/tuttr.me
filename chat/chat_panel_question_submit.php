...
mysql_query ("UPDATE chatname SET username='$username', loginas=1 WHERE id='$chatnameid'") or die(mysql_error());
} else {
mysql_query ("UPDATE chatname SET loginas=2 WHERE id='$chatnameid'") or die(mysql_error());
}
