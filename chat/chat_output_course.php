...
$chatwith_result = mysql_query("SELECT * FROM coursechatname WHERE userid='$touserid' AND userchatid='$touserchatid' AND courseid='$courseid'") or die();
$chatwith_row =  mysql_fetch_array($chatwith_result);
$sendername = $chatwith_row['username'];	
$message[$h] = $row['message'];
$sendtime[$h] = $row['sendtime'];
...
$chat="<div class='chatbox_content_box'>
       <p class='chatbox_content_box_sender'><a href='profile.php?userid=".$touserid."'>".$sendername."</a></p><p class='chatbox_content_box_time'>".date("g:ia",strtotime($timezonename,strtotime($sendtime[0])))."</p>
