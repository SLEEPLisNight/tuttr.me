...
{
document.getElementById("bangding_signup_button").innerHTML = "Pending";
...
xmlhttp_bangding_signup.onreadystatechange=function()
  ...
  if (xmlhttp_bangding_signup.readyState==4 && xmlhttp_bangding_signup.status==200)
	...
	document.getElementById("bangding_signup_button").innerHTML = "Done";
    ...
    document.getElementById("bangding_signup_message").innerHTML="Please check your email to activate your account.";
    }
    else {
	document.getElementById("bangding_signup_button").innerHTML = "Done";
