...
function utf8_urldecode($str) 
{
    ...
    return $str;
	   ...
	   $sql_insert =  mysql_query("INSERT INTO coursecomment (coursemsgid,userid,comment,timesubmit,likes,ip,unread) VALUES('$id','$userid','$comment','$timesubmit','0','$ip','0')") or die(mysql_error());                 

$duitasuo_comment = mysql_query("SELECT * FROM coursecomment WHERE coursemsgid='$id' AND comment='$comment' AND userid='$userid' AND ip='$ip' ORDER BY timesubmit DESC;") OR die(mysql_query());
